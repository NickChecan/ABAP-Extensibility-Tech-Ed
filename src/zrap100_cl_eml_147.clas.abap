CLASS zrap100_cl_eml_147 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_cl_eml_147 IMPLEMENTATION.
...
*        FIELDS ( AgencyID CustomerID BeginDate Description )
  ...
  METHOD update_travel.
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_147
      ENTITY Travel
    ...
    COMMIT ENTITIES
      RESPONSE OF ZRAP100_R_TravelTP_147
